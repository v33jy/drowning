...
# ---------------------------------------------------------------------------
LAT_MIN: float = float(os.getenv("GRID_LAT_MIN", "37.0"))
LAT_MAX: float = float(os.getenv("GRID_LAT_MAX", "37.1"))
LNG_MIN: float = float(os.getenv("GRID_LNG_MIN", "127.0"))
LNG_MAX: float = float(os.getenv("GRID_LNG_MAX", "127.1"))
